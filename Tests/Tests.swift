...
class DateTests: XCTestCase {
    func testDateA() {
        ...
        let resultDate = try! Date(dateString: "2016-01-09T00:00:00")
    ...
    func testDateB() {
        ...
        let resultDate = try! Date(dateString: "2014-03-30T09:13:00Z")
        XCTAssertNotNil(resultDate)
        XCTAssertEqual(date, resultDate)
    }
    ...
    func testDateC() {
        let date = Date.dateWithDayString("2016-01-09")
        let resultDate = try! Date(dateString: "2016-01-09T00:00:00.00")
        XCTAssertNotNil(resultDate)
        XCTAssertEqual(date, resultDate)
    }
    ...
    func testDateD() {
        ...
        let resultDate = try! Date(dateString: "2015-06-23T19:04:19.911Z")
        XCTAssertNotNil(resultDate)
        XCTAssertEqual(date, resultDate)
    }
    ...
    func testDateE() {
        ...
        let resultDate = try! Date(dateString: "2014-01-01T00:00:00+00:00")
    ...
    func testDateF() {
        ...
        let resultDate = try! Date(dateString: "2014-01-02")
    ...
    func testDateG() {
        ...
        let resultDate = try! Date(dateString: "2015-09-10T00:00:00.000000Z")
    ...
    func testDateH() {
        let date = Date.dateWithDayString("2015-09-10")
        let resultDate = try! Date(dateString: "2015-09-10T00:00:00.000+0000")
    ...
    func testDateI() {
        ...
        let resultDate = try! Date(dateString: "2015-06-23T14:40:08.000+02:00")
    ...
    func testDateJ() {
        let date = Date.dateWithDayString("2014-01-02")
        let resultDate = try! Date(dateString: "2014-01-02T00:00:00.000000+00:00")
...
class TimestampDateTests: XCTestCase {
    func testTimestampA() {
        let date = Date.dateWithDayString("2015-09-10")
        let resultDate = try! Date(dateString: "1441843200")
    ...
    func testTimestampB() {
        let date = Date.dateWithDayString("2015-09-10")
        let resultDate = try! Date(dateString: "1441843200000000")
    ...
    func testTimestampC() {
        let date = Date.dateWithDayString("2015-09-10")
        let resultDate = try! Date(unixTimestampNumber: 1441843200)
    ...
    func testTimestampD() {
        let date = Date.dateWithDayString("2015-09-10")
        let resultDate = try! Date(unixTimestampNumber: NSNumber(value: 1441843200000000.0))
